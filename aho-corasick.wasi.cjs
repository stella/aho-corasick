...
const __wasmDebugFilePath = __nodePath.join(
  __dirname,
  "aho-corasick.wasm32-wasi.debug.wasm",
);
...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath =
      require.resolve("@stll/aho-corasick-wasm32-wasi/aho-corasick.wasm32-wasi.wasm");
  } catch {
    throw new Error(
      "Cannot find aho-corasick.wasm32-wasi.wasm file, and @stll/aho-corasick-wasm32-wasi package is not installed.",
    );
  }
}
...
module.exports.AhoCorasick =
  __napiModule.exports.AhoCorasick;
